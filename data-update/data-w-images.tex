...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        ...
        \caption{R1}\label{fig:R1-XX}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-a}}
        \caption{R2}\label{fig:R2-XX}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-a}}
        \caption{R3}\label{fig:R3-XX}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        {\includegraphics[width=\linewidth]{example-image-a}}
        \caption{S1}\label{fig:S1-XX}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}  
        \centering 
        {\includegraphics[width=\linewidth]{example-image-a}}
        \caption{S2}\label{fig:S2-XX}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-a}}
        \caption{S3}\label{fig:S3-XX}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-a}}
        \caption{S4}\label{fig:S4-XX}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-a}}
        \caption{S5}\label{fig:S5-XX}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-a}}
        \caption{S6}\label{fig:S6-00}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        ...
        \caption{R1}\label{fig:R1-RMSD}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-b}}
        \caption{R2}\label{fig:R2-RMSD}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-b}}
        \caption{R3}\label{fig:R3-RMSD}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        {\includegraphics[width=\linewidth]{example-image-b}}
        \caption{S1}\label{fig:S1-RMSD}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}  
        \centering 
        {\includegraphics[width=\linewidth]{example-image-b}}
        \caption{S2}\label{fig:S2-RMSD}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-b}}
        \caption{S3}\label{fig:S3-RMSD}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-b}}
        \caption{S4}\label{fig:S4-RMSD}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-b}}
        \caption{S5}\label{fig:S5-RMSD}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-b}}
        \caption{S6}\label{fig:S6-RMSD}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.475\textwidth}   
        ...
        \caption{R1}\label{fig:R1-RMSF}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-c}}
        \caption{R2}\label{fig:R2-RMSF}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-c}}
        \caption{R3}\label{fig:R3-RMSF}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        {\includegraphics[width=\linewidth]{example-image-c}}
        \caption{S1}\label{fig:S1-RMSF}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}  
        \centering 
        {\includegraphics[width=\linewidth]{example-image-c}}
        \caption{S2}\label{fig:S2-RMSF}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-c}}
        \caption{S3}\label{fig:S3-RMSF}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-c}}
        \caption{S4}\label{fig:S4-RMSF}
    \end{subfigure}
    \vskip\baselineskip
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-c}}
        \caption{S5}\label{fig:S5-RMSF}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.475\textwidth}   
        \centering 
        {\includegraphics[width=\linewidth]{example-image-c}}
        \caption{S6}\label{fig:S6-RMSF}
    \end{subfigure}
